...
import com.example.apz_medsystem.databinding.ItemPatientBinding

class PatientsAdapter: RecyclerView.Adapter<PatientsAdapter.PatientViewHolder>() {
    private lateinit var binding: ItemPatientBinding

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PatientViewHolder {
        binding = ItemPatientBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class PatientViewHolder(binding: ItemPatientBinding): RecyclerView.ViewHolder(binding.root)
}